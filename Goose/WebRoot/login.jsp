		...
		<tr>
			<td align="center">
				...
				<table cellspacing=0 cellpadding=0 width=468 bgcolor=#ffffff
					border=0>
					<tr>
						<td width=16><img  src="images/login_3.jpg"
							width=16>
						</td>
						<td align="center">
							<form name="form1" action="/User/UserAction!login" method="post">
								<table cellspacing=0 cellpadding=0 width=230 border=0>
									...
									<tr height="30px">
										<td></td>
										<td>用户名</td>
										<td><input type="text" name="userName" maxlength="30" size="24"></td>
									</tr>
									<tr height="36px">
										<td>&nbsp;</td>
										<td>密 码</td>
										<td><input type="password" name="password" maxlength="30" size="24"></td>
									</tr>
									<tr height="20px">
										<td></td>
										<td></td>
									...
									<tr style="padding-top: 3px">
										<td>&nbsp;</td>
										<td>&nbsp;</td>
										<td><input type="submit" value="登  录">&nbsp;&nbsp;&nbsp;<input type="reset" value="重  置">
										</td>
									</tr>
								</table>
							</form>
