        ...
        <table width="100%"  height="100%">
        	...
        	<td id="header" height="62" colspan="2" valign="middle" background="${pageContext.request.contextPath }/images/main/BodyBG.gif">
        		...
        		<div id="headerMsg">
        			...
        			&nbsp;&nbsp;[<a href="${pageContext.request.contextPath }/pages/Comm/adminLoginoutAction!get?user.id=${sessionScope.loginUser.id }" target="mainIframe">修改密码</a> | <a href="${pageContext.request.contextPath }/login/adminLoginoutAction!logout">退出登陆</a>]&nbsp;&nbsp;
        		</div>
        		</td>
		  </tr>
       	  <tr id="contentBox">
