				...
				<tr class="tableController">
					<th colspan="5">
						...
						<div class="tableControllerButton">
							<a class="button" href="javascript:void(0)" onclick="this.blur(); window.location='${pageContext.request.contextPath }/pages/Comm/resourceAction!add'; return false;"><span><img src="${pageContext.request.contextPath }/js/kui/icons/application_add.png" align="absmiddle"/>&nbsp;添加新资源</span></a>
