				...
				<tr>
					...
					<td>
						<c:if test="${farm.signDate != null }" >
							<a class="button-small" href="javascript:void(0)" onclick="this.blur(); window.location='${pageContext.request.contextPath }/pages/goose/receiveGooseAction!list?farm.id=${farm.id }'; return false;"><span>查看鹅苗进场记录</span></a>
							<a class="button-small" href="javascript:void(0)" onclick="this.blur(); window.location='${pageContext.request.contextPath }/pages/goose/tradeGooseAction!list?farm.id=${farm.id }'; return false;"><span>查看成品鹅回购记录</span></a>
						</c:if>
