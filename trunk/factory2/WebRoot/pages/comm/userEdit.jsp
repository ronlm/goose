...
<html style="overflow-y: visible;">
  ...
  <body style="overflow-y: visible!important;overflow-y: scroll;">
	  <form action="${pageContext.request.contextPath }/pages/comm/user.do?act=save" name="myForm" id="myForm" method="post">
	    	<table class="mainTable">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<select  validation="required"  name="user.roleId" id="roleId" >
