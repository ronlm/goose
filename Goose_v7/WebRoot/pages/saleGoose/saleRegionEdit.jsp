...
<html style="overflow-y: visible;">
	...
	<body style="overflow-y: visible !important; overflow-y: scroll;">
		<form
			action="${pageContext.request.contextPath }/pages/saleGoose/saleRegionAction!save"
			...
			<table class="mainTable">
				...
				<tbody>
					<tr>
						...
						<td>
							<input type="text" validation="required" name="saleRegion.region"
								id="name" value="${saleRegion.region}" />
							<input type="hidden" name="saleRegion.id" id="id" value="${saleRegion.id}" />
						</td>
					</tr>
				</tbody>
				<tfoot>
