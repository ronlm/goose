			...
			<tr class="tableController">
				<th colspan="7">
					...
					<div class="tableControllerButton">
						...
						<a class="button" href="javascript:void(0)" onclick="this.blur(); window.location='${pageContext.request.contextPath }/pages/goose/saleRegionAction!list'; return false;"><span><img src="${pageContext.request.contextPath }/js/kui/icons/application_go.png" align="absmiddle"/>&nbsp;查看全部销售分区信息</span></a>
