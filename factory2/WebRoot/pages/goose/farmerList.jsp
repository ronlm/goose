  	...
  	<body style="overflow-y: visible;" onload="changeRowColor();">
		...
		<!-- demo 开始 -->
			<tr>
				...
				<td>13800000000</td>
				<td>
					<a class="button-small" href="javascript:void(0)" onclick="this.blur(); window.location='#'; return false;"><span>修改</span></a>
					<a class="button-small" href="javascript:void(0)" onclick="this.blur(); deleteOne('#'); return false;"><span>删除</span></a>
				</td>
			</tr>
		<!-- demo 结束 -->
		<!--  
