...
<html style="overflow-y: visible;">
  ...
  <body style="overflow-y: visible!important;overflow-y: scroll;">
	  <form action="${pageContext.request.contextPath }/pages/Comm/menuAction!save" name="myForm" id="myForm" method="post">
	    	<table class="mainTable">
				...
				<tbody>
					<tr>
						...
						<input type="hidden" name="menu.id" id="id" value="${menu.id==null?"":menu.id}"/>
						</td>
					</tr> 
					<tr>
					...
					<tr>
						...
						<td>
							<select name="menu.image" validation="required" id="image">
								...
								<option value="/images/main/MenuIcon.png" <c:if test="${0 == menu.pid}">selected</c:if>>/images/main/MenuIcon.png</option>
							</select>
						</td>
					</tr> 
					<tr>
